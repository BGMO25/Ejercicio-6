 ...
 * @author USUARIO
 */
public class Figura_1 extends JFrame{
    ...
    public Figura_1(String title) throws HeadlessException {
        super(title);
    ...
    public void IniciarPaneles(){
        ...
        this.jpanellist.get(0).setBackground(Color.DARK_GRAY);
    }
    
    public void IniciarEtiquetas(){
        this.jlabellist1=new ArrayList<>();
        this.jlabellist1.add(new JLabel("INSCRIBETE"));
