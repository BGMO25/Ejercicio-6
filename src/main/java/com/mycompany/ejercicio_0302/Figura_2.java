 ...
 * @author USUARIO
 */
public class Figura_2 extends JFrame{
    ...
    public Figura_2(String title) throws HeadlessException {
        super(title);
    ...
    public void IniciarTexto(){
        ...
        this.jTextField1.add(new JTextField("Morocho Yari"));
        this.jTextField1.add(new JTextField("Boris Fernando"));
        this.jTextField1.add(new JTextField("Ecuatoriana"));
        this.jTextField1.add(new JTextField("Masculono"));
        this.jTextField1.add(new JTextField("bmorochoy1@est.ups.edu.ec"));
        this.jTextField1.add(new JTextField("08/12/97"));
        this.jTextField1.add(new JTextField("2898446"));
        this.jTextField1.add(new JTextField("0989511957"));
        ...
        this.jPanelList1.get(8).add(this.jTextField1.get(9));
